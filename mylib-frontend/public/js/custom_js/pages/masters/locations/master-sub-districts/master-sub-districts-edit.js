$(document).ready(function(){
    ...
    function validateForm(validationErrors) {
        ...
        Object.keys(validationErrors).forEach(function (fieldName) {
            ...
            var errorMessage = '';
            if(fieldName == 'sub_district_name'){
    ...
    $('#form-edit-master-sub-districts').on('submit', function(e){
        e.preventDefault();
        ...
        $.ajax({
            url : '/master-sub-districts/'+ sub_district_id,
            type : 'post',
            data : form_data,
            dataType: 'json',
            cache: false,
            ...
            success: function(response) {
                if(response.status == true){
                    ...
                    setTimeout(function() {
                        window.location.href = '/master-sub-districts/' + sub_district_id;
                    }, 1000); //
                }else{
                    iziToast.error({
