$(document).ready(function(){
    ...
    function validateForm(validationErrors) {
        ...
        Object.keys(validationErrors).forEach(function (fieldName) {
            ...
            var errorMessage = '';
            if(fieldName == 'customer_category_name'){
    ...
    $('#form-edit-master-customer-categories').on('submit', function(e){
        e.preventDefault();
        ...
        $.ajax({
            url : '/master-customer-categories/'+ customer_category_id,
            type : 'post',
            data : form_data,
            dataType: 'json',
            cache: false,
            ...
            success: function(response) {
                if(response.status == true){
                    ...
                    setTimeout(function() {
                        window.location.href = '/master-customer-categories/' + customer_category_id;
                    }, 1000); //
                }else{
                    iziToast.error({
