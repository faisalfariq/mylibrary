$(document).ready(function(){
    ...
    $('#form-add-master-products').on('submit', function(e){
        e.preventDefault();
        ...
        $.ajax({
            ...
            error: function(error) {
                if(error.responseJSON.message.includes("Duplicate entry")){
                    errormessage = "Oops! The Product SKU you're trying to use is already taken. Please choose a unique one to avoid duplication.";
                }else{
